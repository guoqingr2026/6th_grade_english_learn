...
### 第 3 步：开启 GitHub Pages（选「分支」方式）

1. 左侧 **Pages**：https://github.com/guoqingr2026/6th_grade_english_learn/settings/pages  
2. **Build and deployment**
   - **Source**：**Deploy from a branch**（从分支部署）
   - **Branch**：`gh-pages` → **/ (root)** → **Save**
3. **不要**选「GitHub Actions」——本项目用的是自动推送到 `gh-pages` 分支的方式（#3、#4 已成功）。
4. 若刚改过设置，到 **Actions** → **Deploy to GitHub Pages** → **Run workflow** 手动跑一次。
